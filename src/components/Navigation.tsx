...
export const Navigation = () => {
  ...
  return (
    <motion.nav
      ...
      className="fixed top-6 left-1/2 z-50 flex w-[95%] max-w-[760px] items-center justify-between rounded-full border border-white/10 bg-[#0a0a0a]/70 px-4 py-2 backdrop-blur-[16px]"
    >
