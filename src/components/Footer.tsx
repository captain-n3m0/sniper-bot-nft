    ...
    <footer className="mt-24 border-t border-white/5 bg-[#050505] px-6 py-16">
      <div className="mx-auto max-w-7xl">
        <div className="grid grid-cols-1 gap-12 md:grid-cols-4">
          ...
          <div>
            <h4 className="mb-6 font-mono text-[10px] uppercase tracking-[0.2em] text-neutral-500">Resources</h4>
            <ul className="space-y-3 text-sm text-neutral-400">
              <li><a href="#" className="hover:text-white">GitHub Repo</a></li>
              <li><a href="#" className="hover:text-white">Ethers.js Docs</a></li>
              <li><a href="#" className="hover:text-white">SeaDrop Contract</a></li>
              <li><a href="#" className="hover:text-white">OpenSea API</a></li>
            </ul>
          </div>
          <div>
            <h4 className="mb-6 font-mono text-[10px] uppercase tracking-[0.2em] text-neutral-500">Legal</h4>
            <ul className="space-y-3 text-sm text-neutral-400">
        ...
        <div className="mt-24 flex flex-col items-center justify-between border-t border-white/5 pt-8 md:flex-row">
          <p className="text-sm text-neutral-600">© 2026 morsyxbt. Open Source Software.</p>
